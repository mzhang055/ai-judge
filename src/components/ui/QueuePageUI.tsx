/**
 * QueuePageUI - Presentation component (UI only)
 */
...
import type { EvaluationProgress } from '../../services/evaluationService';

interface QueuePageUIProps {
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div style={{ display: 'flex', gap: '12px' }}>
          <button style={styles.backButton} onClick={onBackToQueues}>
            <ArrowLeft size={16} />
        ...
        <div style={styles.titleRow}>
          ...
          <div style={styles.actionButtons}>
            <button style={styles.resultsButton} onClick={onViewResults}>
              <BarChart3 size={16} />
      ...
      {showResults && !isRunning && (
        <>
          <div style={styles.backdrop} onClick={onCloseResults} />
          <div style={styles.resultsModal}>
            ...
            <div style={styles.modalButtons}>
              <button style={styles.viewResultsButton} onClick={onViewResults}>
                View Results
              </button>
              <button style={styles.closeButton} onClick={onCloseResults}>
                Close
              </button>
            </div>
          </div>
